...
const GROUPS = [
  ...
  },
  {
    ...
    keys: [
      ...
      ['MASTER_WALLET_ADDRESS', ['MASTER_WALLET_ADDRESS', 'TRON_MASTER_WALLET', 'MASTER_TRON_ADDRESS', 'TRON_MASTER_ADDRESS']],
      ['TRON_API_KEY', ['TRON_API_KEY', 'TRONGRID_API_KEY', 'TRON_PRO_API_KEY']],
