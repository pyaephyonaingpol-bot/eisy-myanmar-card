...
(function (global) {
  ...
  const messages = {
    en: {
      ...
      apply_new_card_toggle_hint: 'Open only when you need another virtual card',
      ...
      hide_card_information: 'Hide Card Information',
      card_info_privacy_hint: 'Card number, expiry, and CVV stay hidden until you open Card Information on that card.',
      card_info_collapsed_hint: 'Details stay hidden until you open Card Information.',
      no_cards_yet_hint: 'No cards yet — apply for a virtual card below.',
    ...
    my: {
      ...
      withdraw_usdt_hint: 'USDT ကို crypto wallet သို့ ထုတ်ယူနိုင်သည် သို့မဟုတ် ပလက်ဖောင်းနှုန်းဖြင့် MMK ဘဏ်အကောင့်သို့ ပြန်ထုတ်နိုင်သည်။ MMK → USDT ပြောင်းလဲမှု မရရှိပါ။',
      ...
      apply_new_card_toggle_hint: 'ကဒ်အသစ်လိုမှသာ ဖွင့်ပါ',
      ...
      card_information: 'ကဒ်အချက်အလက်',
      hide_card_information: 'ကဒ်အချက်အလက် ဖျောက်မည်',
      card_info_privacy_hint: 'ကဒ်နံပါတ်၊ သက်တမ်းနှင့် CVV ကို Card Information ဖွင့်မှသာ ပြသမည်။',
      card_info_collapsed_hint: 'Card Information ဖွင့်မှသာ အသေးစိတ်ကို ပြသမည်။',
      no_cards_yet_hint: 'ကဒ်မရှိသေးပါ — အောက်တွင် ကဒ်အသစ် လျှောက်ထားပါ။',
      awaiting_issuance: 'ထုတ်ပေးရန် စောင့်ဆိုင်းနေသည်',
