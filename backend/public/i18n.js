...
(function (global) {
  ...
  const messages = {
    en: {
      ...
      withdraw_usdt_hint: 'Withdraw USDT on TRC20 from our master wallet (automated, fixed $2 fee), to BEP20 (manual), or convert at the platform rate to MMK in your bank account. MMK wallet → USDT exchange is not available.',
      ...
      withdraw_method_nowpayments_hint: 'Automated TRC20 payout from our master wallet (manual energy). Fixed $2 USDT fee.',
      withdraw_method_crypto: 'USDT TRC20 (Master Wallet)',
      withdraw_method_crypto_hint: 'Automated TRC20 payout from our master wallet (manual energy). Fixed $2 USDT fee. BEP20 remains manual.',
      ...
      card_bin: 'Card BIN',
      card_bin_required: 'Select or enter a card BIN',
      pay_from: 'Pay From',
      pay_mmk_wallet_issuance: 'MMK Wallet — not available for card issuance',
      pay_usdt_wallet_issuance: 'USDT Wallet (1 USDT ≈ 1 USD — instant issue)',
      usdt_no_mmk_rate: 'USDT wallet: 1 USDT ≈ 1 USD — no MMK exchange rate',
    ...
    my: {
      ...
      header_mmk_wallet_hint: 'ကဒ်၊ reload & ဘဏ်ထုတ်ယူခြင်း · MMK→USDT ပြောင်းလဲမှု မရှိ',
      ...
      withdraw_usdt_hint: 'TRC20 USDT ကို master wallet မှ အလိုအလျောက် ထုတ်ယူနိုင်သည် (ပုံမှန် $2 fee)၊ BEP20 (manual) သို့မဟုတ် ပလက်ဖောင်းနှုန်းဖြင့် MMK ဘဏ်အကောင့်သို့ ပြန်ထုတ်နိုင်သည်။ MMK → USDT ပြောင်းလဲမှု မရရှိပါ။',
      ...
      withdraw_method_nowpayments: 'USDT TRC20 (Master Wallet)',
      withdraw_method_nowpayments_hint: 'Master wallet မှ TRC20 သို့ အလိုအလျောက် ထုတ်ပေးမည် (manual energy)။ ပုံမှန် $2 USDT fee။',
      withdraw_method_crypto: 'USDT TRC20 (Master Wallet)',
      withdraw_method_crypto_hint: 'Master wallet မှ TRC20 သို့ အလိုအလျောက် ထုတ်ပေးမည် (manual energy)။ ပုံမှန် $2 USDT fee။ BEP20 သည် manual ဖြစ်သည်။',
      ...
      card_bin: 'Card BIN',
      card_bin_required: 'Card BIN ရွေးပါ သို့မဟုတ် ထည့်ပါ',
      pay_from: 'ပေးချေရမည့်နေရာ',
      pay_mmk_wallet_issuance: 'MMK ပိုက်ဆံအိတ် — ကဒ်ထုတ်ပေးခြင်းအတွက် မရရှိနိုင်ပါ',
      pay_usdt_wallet_issuance: 'USDT ပိုက်ဆံအိတ် (1 USDT ≈ 1 USD — ချက်ချင်း ထုတ်ပေးမည်)',
      usdt_no_mmk_rate: 'USDT: 1 USDT ≈ 1 USD — MMK ငွေလဲနှုန်း မလိုအပ်ပါ',
      ...
      mmk_wallet_restriction: 'MMK ပိုက်ဆံအိတ်သည် ကဒ်၊ reload နှင့် ဘဏ်ထုတ်ယူခြင်းအတွက်သာ။ MMK → USDT ပြောင်းလဲမှု မရရှိပါ။',
