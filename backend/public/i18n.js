...
(function (global) {
  ...
  const messages = {
    en: {
      ...
      withdraw_usdt_hint: 'Withdraw USDT via NOWPayments to a TRC20 wallet, to another crypto network, or convert at the platform rate to MMK in your bank account. MMK wallet → USDT exchange is not available.',
      ...
      withdraw_method_nowpayments: 'NOWPayments (USDT TRC20)',
      withdraw_method_nowpayments_hint: 'Automated payout to your TRC20 wallet via NOWPayments.',
      withdraw_method_crypto: 'Crypto Wallet (USDT)',
      withdraw_method_crypto_hint: 'Send USDT to TRC20 or BEP20. Processing may be manual if NOWPayments is unavailable.',
      ...
      btn_withdraw_nowpayments: 'Withdraw with NOWPayments',
      ...
      usdt_wallet_hint: 'NOWPayments USDT TRC20 deposit · 1 USDT ≈ 1 USD to card (after fee)',
      ...
      deposit_tab_usdt: 'NOWPayments (USDT TRC20)',
    ...
    my: {
      ...
      withdraw_usdt_hint: 'USDT ကို NOWPayments ဖြင့် TRC20 wallet သို့ ထုတ်ယူနိုင်သည်၊ အခြား crypto network သို့ ပို့နိုင်သည် သို့မဟုတ် ပလက်ဖောင်းနှုန်းဖြင့် MMK ဘဏ်အကောင့်သို့ ပြန်ထုတ်နိုင်သည်။ MMK → USDT ပြောင်းလဲမှု မရရှိပါ။',
      ...
      withdraw_method_nowpayments: 'NOWPayments (USDT TRC20)',
      withdraw_method_nowpayments_hint: 'NOWPayments မှတစ်ဆင့် TRC20 wallet သို့ အလိုအလျောက် ထုတ်ပေးမည်။',
      withdraw_method_crypto: 'Crypto Wallet (USDT)',
      withdraw_method_crypto_hint: 'TRC20 သို့မဟုတ် BEP20 သို့ USDT ပို့မည်။ NOWPayments မရရှိပါက ကိုယ်တိုင် စီမံနိုင်သည်။',
      ...
      btn_withdraw_nowpayments: 'NOWPayments ဖြင့် ထုတ်ယူမည်',
      btn_submit_withdraw: 'ထုတ်ယူရန် တင်သွင်းမည်',
      withdraw_network: 'Network',
