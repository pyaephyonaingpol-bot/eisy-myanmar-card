...
(function (global) {
  ...
  const messages = {
    en: {
      ...
      header_mmk_wallet_hint: 'Reloads & bank withdrawal · no MMK→USDT convert',
      ...
      mmk_wallet_restriction: 'MMK wallet is for card reloads and bank withdrawals only. New cards require USDT. MMK → USDT conversion is not available.',
    ...
    my: {
      ...
      header_mmk_wallet_hint: 'Reload & ဘဏ်ထုတ်ယူခြင်း · MMK→USDT ပြောင်းလဲမှု မရှိ',
      ...
      mmk_wallet_restriction: 'MMK ပိုက်ဆံအိတ်သည် ကဒ် reload နှင့် ဘဏ်ထုတ်ယူခြင်းအတွက်သာ။ ကဒ်အသစ်အတွက် USDT လိုအပ်သည်။ MMK → USDT ပြောင်းလဲမှု မရရှိပါ။',
