...
(function (global) {
  ...
  const messages = {
    en: {
      ...
      scan_pay_hint: 'Scan a USDT payment QR with your camera or upload an image. Confirm the amount, then pay from your wallet.',
    ...
    my: {
      ...
      btn_scan_pay: 'Scan Pay',
      scan_pay_title: 'Scan Pay',
      scan_pay_hint: 'Camera သို့မဟုတ် QR ပုံဖြင့် USDT ပေးချေရန် စကင်ဖတ်ပါ။',
