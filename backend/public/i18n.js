...
(function (global) {
  ...
  const messages = {
    en: {
      ...
      apply_new_card_hint: 'Pay from your USDT wallet. Your virtual card is issued automatically via Bitnob (1 USDT ≈ 1 USD).',
      ...
      bitnob_customer_required: 'Complete Card KYC first so a Bitnob customer profile is ready, then try again.',
      pay_from: 'Pay From',
      ...
      // Card wallet hints
      card_wallet_ok_usdt: 'USDT wallet sufficient — {{available}} available ({{required}} required). Card will be issued instantly via Bitnob.',
    ...
    my: {
      ...
      apply_new_card_hint: 'USDT ပိုက်ဆံအိတ်မှ ပေးချေပါ။ Virtual card ကို Bitnob ဖြင့် အလိုအလျောက် ထုတ်ပေးမည် (1 USDT ≈ 1 USD)။',
      ...
      bitnob_customer_required: 'Bitnob customer profile အဆင်သင့်ဖြစ်ရန် Card KYC ကို အရင် ပြီးအောင်လုပ်ပါ။',
      ...
      card_wallet_ok_usdt: 'USDT ပိုက်ဆံအိတ် လုံလောက်သည် — {{available}} ရှိ ({{required}} လိုအပ်)။ Bitnob ဖြင့် ချက်ချင်း ထုတ်ပေးမည်။',
